      ...
      <div className="contain flex-col items-start justify-start">
        ...
        <div className="grid mt-[60px]   sm:mt-[100px] gap-[0px] self-center grid-cols-2 xs:grid-cols-3 relative w-full max-w-[580px] grid-rows-[auto__1fr__1fr] sm:gap-0 gap-y-[40px] xs:gap-y-[60px] sm:grid-rows-[220px__auto__220px]">
          ...
          >
            ...
            <p className="text-white delay1 eco-words group-hover:right-[110%] transition-all duration-500 group-hover:bottom-[110%] text-base font-semibold lg:block hidden absolute right-full bottom-full">
              Pubs
            </p>
            <p className="text-white delay5 eco-words text-base font-semibold lg:block hidden min-w-[100px] absolute right-[110%] top-[40%] group-hover:right-[120%]  transition-all duration-500">
              Retail Units
            </p>
            <p className="text-white delay3 eco-words group-hover:right-[110%]  transition-all duration-500 text-center text-base font-semibold lg:block hidden min-w-[130px] absolute group-hover:top-[110%] right-full top-full">
          ...
          >
            ...
            <p className="text-white dealay2 eco-words  group-hover:right-[110%] group-hover:bottom-[110%] transition-all duration-500 text-center lg:block hidden min-w-[150px] text-base font-semibold absolute right-full bottom-full">
            ...
            <p className="text-white eco-words delay1  text-center group-hover:left-[100%] group-hover:bottom-[110%] transition-all duration-500 text-base font-semibold lg:block hidden min-w-[130px] absolute left-[90%] bottom-full">
              Bistros
            </p>
          ...
          >
            ...
            <p className="text-white eco-word delay5  text-center group-hover:left-[80%] group-hover:bottom-[130%] transition-all duration-500  text-base lg:block hidden font-semibold absolute left-[70%] bottom-[120%]">
              Brasseries
            </p>
            <p className="text-white eco-words delay1  group-hover:left-[160%] group-hover:bottom-[95%] transition-all duration-500 text-base font-semibold lg:block hidden min-w-[100px] absolute left-[150%] bottom-[85%] -translate-x-1/2">
              Clubs
            </p>
            ...
            <p className="text-white  eco-words delay2 text-center text-base font-semibold lg:block hidden min-w-[130px] absolute left-[80%] bottom-[0%] group-hover:left-[90%] group-hover:-bottom-[10%] transition-all duration-500">
              Buffets
            </p>
            <div className="absolute -inset-[4px] bg-blueGr -z-10 rounded-full group-hover:bg-hoverSol"></div>
          ...
          >
            ...
            <p className="text-white delay2 eco-words  text-base font-semibold lg:block hidden min-w-[100px] absolute right-[120%] top-[60%] -translate-y-1/2 group-hover:right-[130%] group-hover:top-[70%] transition-all duration-500">
              Offices
            </p>
            <p className="text-white delay4 eco-words  text-center text-base font-semibold lg:block hidden min-w-[100px] absolute right-[120%] top-[100%] group-hover:right-[130%] group-hover:top-[110%] transition-all duration-500">
              Food Retail Units
            </p>
            <div className="absolute -inset-[4px] bg-blueGr -z-10 rounded-full group-hover:bg-hoverSol"></div>
          ...
          >
            ...
            <p className="text-white delay1 eco-words  text-center  text-base lg:block hidden font-semibold absolute left-full -bottom-[20%] group-hover:left-[110%] group-hover:-bottom-[30%] transition-all duration-500">
              Restaurants
            </p>
            <p className="text-white eco-words delay5  text-base font-semibold lg:block hidden min-w-[100px] absolute left-[20%] top-[130%] -translate-x-1/2  group-hover:top-[140%] transition-all duration-500">
              Warehouses
            </p>
          ...
          >
            ...
            <p className="text-white eco-words delay3   text-center  text-base lg:block hidden font-semibold absolute left-[120%] bottom-[50%] group-hover:left-[130%] group-hover:bottom-[60%] transition-all duration-500">
              Accomodation <br /> units
            </p>
            <p className="text-white eco-words delay1  text-base font-semibold lg:block hidden min-w-[100px] absolute left-[120%] -bottom-[10%]  group-hover:left-[130%] group-hover:-bottom-[10%] transition-all duration-500">
              Street Foods
            </p>
            <p className="text-white eco-words  delay4 text-center text-base font-semibold lg:block hidden min-w-[130px] absolute right-[0%] top-[120%] -translate-y-1/2 group-hover:-right-[10%] group-hover:top-[130%] transition-all duration-500">
              Cafes
            </p>
            <div className="absolute -inset-[4px] bg-blueGr -z-10 rounded-full group-hover:bg-hoverSol"></div>
