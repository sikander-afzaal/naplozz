  ...
  return (
    <div className="wrapper relative mt-[80px] md:mt-[160px]">
      ...
      <div className="contain flex-col gap-[60px] md:gap-[0px] justify-start items-center  md:items-start">
        ...
        <img src="/explore/line1.png" className="md:block hidden" alt="" />
        <h2 className="gr-text text-[35px] sm:text-[50px] lg:text-[72px] font-bold md:text-left text-center">
          Business owners and managers.
        </h2>
        <div className=" mb-5 justify-start items-center md:flex hidden">
          <img src="/explore/line2.png" alt="" />
          <img src="/explore/line3.png" alt="" />
        </div>
        ...
        <div className="w-full justify-start md:flex-row flex-col-reverse items-center gap-[40px] md:gap-[70px] flex">
          ...
          <h2 className="gr-text relative max-w-[600px]  text-[35px] sm:text-[50px] lg:text-[72px] font-bold md:text-right text-center">
        ...
        <div className="w-full justify-start md:flex-row flex-col items-center gap-[40px] md:gap-[120px] flex">
          <h2 className="gr-text relative max-w-[600px]  text-[35px] sm:text-[50px] lg:text-[72px] font-bold md:text-left text-center">
        ...
        <img
          ...
          alt=""
        />
        <h2 className="text-white text-[35px] sm:text-[50px] lg:text-[72px] font-bold md:text-left text-center">
          Naplozz Marketplace usages:
        </h2>
        <div className="md:flex hidden mb-5 justify-start items-center">
          <img src="/explore/line7.png" alt="" />
          <img src="/explore/line8.png" alt="" />
        </div>
