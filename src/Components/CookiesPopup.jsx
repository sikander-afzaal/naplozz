...
const CookiesPopup = ({ setModal }) => {
  return (
    <>
      <div className="fixed z-[90] flex rounded-[20px] justify-center items-start flex-col gap-5 px-4 sm:px-8 py-4 bottom-0 sm:bottom-4 left-0 sm:left-4  bg-black border-[1px] border-solid border-[#B3B3B3] w-full h-full max-w-[450px] max-h-[272px]">
        <svg
        ...
        <p className="text-white font-medium text-xl">
          We use cookies for personlized content and ads
        </p>
