const GradientButton = ({ text, classes }) => {
  return (
    <button
      className={` rounded-full flex justify-center items-center bg-btnBg relative isolate border-none text-white cursor-pointer group font-semibold text-base ${classes}`}
    >
