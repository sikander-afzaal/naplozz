...
const SubscribeBox = React.forwardRef(
  ({ heading, price, perks, recommended, users, discount }, ref) => {
    return (
      <div
        ref={ref}
        className="w-full group max-w-full xl:max-w-[266px] xl:h-auto h-full mid:max-w-[306px] rounded-[30px]  relative"
      >
        <div
